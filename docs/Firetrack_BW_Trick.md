...
October 1985, section 3.4 "RGB + PAL encoder + UHF output", printed page 19,
PDF page 29 of the chrisacorns scan; the same circuit is described in *A
Hardware Guide for the BBC Microcomputer*, chapter 3):
...
- **Killer threshold and attack/release** decide the marginal cases: a low
  ...
  giving flickering or intermittent colour.
...
- [BBC Microcomputer Service Manual, Oct 1985, part 1 (chrisacorns)](https://chrisacorns.computinghistory.org.uk/docs/Acorn/Manuals/Acorn_BBCSMOct85_Sec1.pdf):
  the PAL encoder passage is section 3.4 "RGB + PAL encoder + UHF output",
  printed page 19 (page 29 of the PDF scan)
...
parity-inversion consequence and the TV-dependence analysis are this
document's reasoning, not quotation.
